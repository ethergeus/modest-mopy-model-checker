...
# States
class State(object):
	__slots__ = ("counter", "pc1", "coin1", "pc2", "coin2", "pc3", "coin3", "pc4", "coin4", "pc5", "coin5", "pc6", "coin6")
...
# Automaton: process1 || process2 || process3 || process4 || process5 || process6
class process1____process2____process3____process4____process5____process6Automaton(object):
	__slots__ = ("network", "transition_counts", "transition_labels", "branch_counts")
	
	def __init__(self, network: Network):
		self.network = network
		self.transition_counts = [38]
		self.transition_labels = [[2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 3]]
		self.branch_counts = [[2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 1, 1]]
	...
	def get_transient_value(self, state: State, transient_variable: str):
		...
		if location == 0:
			if transient_variable == "finished":
				return ((((state.pc6 == 3) and (state.pc2 == 3)) and ((state.pc4 == 3) and (state.pc3 == 3))) and ((state.pc5 == 3) and (state.pc1 == 3)))
			elif transient_variable == "all_coins_equal_0":
				return ((((state.coin6 == 0) and (state.coin2 == 0)) and ((state.coin4 == 0) and (state.coin3 == 0))) and ((state.coin5 == 0) and (state.coin1 == 0)))
			elif transient_variable == "all_coins_equal_1":
				return ((((state.coin6 == 1) and (state.coin2 == 1)) and ((state.coin4 == 1) and (state.coin3 == 1))) and ((state.coin5 == 1) and (state.coin1 == 1)))
			elif transient_variable == "agree":
				return ((((state.coin5 == state.coin6) and (state.coin2 == state.coin3)) and (state.coin3 == state.coin4)) and ((state.coin4 == state.coin5) and (state.coin1 == state.coin2)))
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			if transition == 0:
				...
				return (((state.pc1 == 1) and (state.coin1 == 1)) and (state.counter < 36))
			elif transition == 3:
				return ((state.pc1 == 2) and (state.counter <= 6))
			elif transition == 4:
				return ((state.pc1 == 2) and (state.counter >= 30))
			elif transition == 5:
				return (((state.pc1 == 2) and (state.counter > 6)) and (state.counter < 30))
			elif transition == 6:
				return (state.pc2 == 0)
			elif transition == 7:
				return (((state.pc2 == 1) and (state.coin2 == 0)) and (state.counter > 0))
			elif transition == 8:
				return (((state.pc2 == 1) and (state.coin2 == 1)) and (state.counter < 36))
			elif transition == 9:
				return ((state.pc2 == 2) and (state.counter <= 6))
			elif transition == 10:
				return ((state.pc2 == 2) and (state.counter >= 30))
			elif transition == 11:
				return (((state.pc2 == 2) and (state.counter > 6)) and (state.counter < 30))
			elif transition == 12:
				return (state.pc3 == 0)
			elif transition == 13:
				return (((state.pc3 == 1) and (state.coin3 == 0)) and (state.counter > 0))
			elif transition == 14:
				return (((state.pc3 == 1) and (state.coin3 == 1)) and (state.counter < 36))
			elif transition == 15:
				return ((state.pc3 == 2) and (state.counter <= 6))
			elif transition == 16:
				return ((state.pc3 == 2) and (state.counter >= 30))
			elif transition == 17:
				return (((state.pc3 == 2) and (state.counter > 6)) and (state.counter < 30))
			elif transition == 18:
				return (state.pc4 == 0)
			elif transition == 19:
				return (((state.pc4 == 1) and (state.coin4 == 0)) and (state.counter > 0))
			elif transition == 20:
				return (((state.pc4 == 1) and (state.coin4 == 1)) and (state.counter < 36))
			elif transition == 21:
				return ((state.pc4 == 2) and (state.counter <= 6))
			elif transition == 22:
				return ((state.pc4 == 2) and (state.counter >= 30))
			elif transition == 23:
				return (((state.pc4 == 2) and (state.counter > 6)) and (state.counter < 30))
			elif transition == 24:
				return (state.pc5 == 0)
			elif transition == 25:
				return (((state.pc5 == 1) and (state.coin5 == 0)) and (state.counter > 0))
			elif transition == 26:
				return (((state.pc5 == 1) and (state.coin5 == 1)) and (state.counter < 36))
			elif transition == 27:
				return ((state.pc5 == 2) and (state.counter <= 6))
			elif transition == 28:
				return ((state.pc5 == 2) and (state.counter >= 30))
			elif transition == 29:
				return (((state.pc5 == 2) and (state.counter > 6)) and (state.counter < 30))
			elif transition == 30:
				return (state.pc6 == 0)
			elif transition == 31:
				return (((state.pc6 == 1) and (state.coin6 == 0)) and (state.counter > 0))
			elif transition == 32:
				return (((state.pc6 == 1) and (state.coin6 == 1)) and (state.counter < 36))
			elif transition == 33:
				return ((state.pc6 == 2) and (state.counter <= 6))
			elif transition == 34:
				return ((state.pc6 == 2) and (state.counter >= 30))
			elif transition == 35:
				return (((state.pc6 == 2) and (state.counter > 6)) and (state.counter < 30))
			elif transition == 36:
				return ((((((state.pc1 == 3) and (state.pc2 == 3)) and (state.pc3 == 3)) and (state.pc4 == 3)) and (state.pc5 == 3)) and (state.pc6 == 3))
			elif transition == 37:
				return True
			else:
				raise IndexError
			...
			if location == 0:
				if transition == 0:
					...
					if branch == 0:
						...
						target_transient.exit_reward_0 = (1 - 0)
						target_state.counter = (state.counter + 1)
						if target_state.counter > 36:
							raise OverflowError("Assigned value of " + str(target_state.counter) + " is greater than the upper bound of 36 for variable \"counter\".")
						target_state.pc1 = 2
						target_state.coin1 = 0
				elif transition == 3:
					if branch == 0:
...
class Network(object):
	__slots__ = ("network", "model_type", "components", "transition_labels", "sync_vectors", "properties", "variables", "_initial_transient", "_aut_process1____process2____process3____process4____process5____process6")
	...
	def __init__(self):
		...
		self.variables = [
			VariableInfo("counter", None, "int", 0, 36),
		...
		self._aut_process1____process2____process3____process4____process5____process6 = process1____process2____process3____process4____process5____process6Automaton(self)
		self.components = [self._aut_process1____process2____process3____process4____process5____process6]
	...
	def get_initial_state(self) -> State:
		...
		state.pc6 = 0
		state.coin6 = 0
		self._aut_process1____process2____process3____process4____process5____process6.set_initial_values(state)
		return state
	...
	def _get_initial_transient(self) -> Transient:
		...
		self._aut_process1____process2____process3____process4____process5____process6.set_initial_transient_values(transient)
		return transient
	...
	def _get_transient_value(self, state: State, transient_variable: str):
		...
		result = self._aut_process1____process2____process3____process4____process5____process6.get_transient_value(state, transient_variable)
	...
	def get_transitions(self, state: State) -> List[Transition]:
		...
		transitions = []
		trans_process1____process2____process3____process4____process5____process6 = [[], [], [], []]
		transition_count = self._aut_process1____process2____process3____process4____process5____process6.get_transition_count(state)
		for i in range(transition_count):
			if self._aut_process1____process2____process3____process4____process5____process6.get_guard_value(state, i):
				trans_process1____process2____process3____process4____process5____process6[self._aut_process1____process2____process3____process4____process5____process6.get_transition_label(state, i)].append(i)
		...
		for svi in range(len(self.sync_vectors)):
			...
			if synced is not None:
				if sv[0] != -1:
					if len(trans_process1____process2____process3____process4____process5____process6[sv[0]]) == 0:
						synced = None
					else:
						existing = len(synced)
						for i in range(existing):
							synced[i][0] = trans_process1____process2____process3____process4____process5____process6[sv[0]][0]
						for i in range(1, len(trans_process1____process2____process3____process4____process5____process6[sv[0]])):
							for j in range(existing):
								synced.append(synced[j][:])
								synced[-1][0] = trans_process1____process2____process3____process4____process5____process6[sv[0]][i]
			if synced is not None:
				for sync in synced:
					sync[-1] = sv[-1]
					sync.append(svi)
	...
	def get_branches(self, state: State, transition: Transition) -> List[Branch]:
		...
		if transition.transitions[0] != -1:
			existing = len(combs)
			branch_count = self._aut_process1____process2____process3____process4____process5____process6.get_branch_count(state, transition.transitions[0])
			for i in range(1, branch_count):
				probability = self._aut_process1____process2____process3____process4____process5____process6.get_probability_value(state, transition.transitions[0], i)
				for j in range(existing):
					combs.append(combs[j][:])
					combs[-1][0] = i
					probs.append(probs[j] * probability)
			probability = self._aut_process1____process2____process3____process4____process5____process6.get_probability_value(state, transition.transitions[0], 0)
			for i in range(existing):
				combs[i][0] = 0
				probs[i] *= probability
	...
	def jump(self, state: State, transition: Transition, branch: Branch, expressions: List[int] = []) -> State:
		...
		for i in range(0, 1):
			...
			if transition.transitions[0] != -1:
				self._aut_process1____process2____process3____process4____process5____process6.jump(state, transient, transition.transitions[0], branch.branches[0], i, target_state, target_transient)
			state = target_state
