...
# Automaton: process1 || process2 || process3 || process4 || process5 || process6 || process7 || process8 || process9 || process10
class process1____process2____process3____process4____process5____process6____process7____process8____process9____process10Automaton(object):
	__slots__ = ("network", "transition_counts", "transition_labels", "branch_counts")
	
	def __init__(self, network: Network):
		self.network = network
		self.transition_counts = [62]
		self.transition_labels = [[2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 3]]
		self.branch_counts = [[2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1, 1, 1]]
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			if transition == 0:
				...
				return ((((((((((state.pc1 == 3) and (state.pc2 == 3)) and (state.pc3 == 3)) and (state.pc4 == 3)) and (state.pc5 == 3)) and (state.pc6 == 3)) and (state.pc7 == 3)) and (state.pc8 == 3)) and (state.pc9 == 3)) and (state.pc10 == 3))
			elif transition == 61:
				return True
			else:
				raise IndexError
...
class Network(object):
	__slots__ = ("network", "model_type", "components", "transition_labels", "sync_vectors", "properties", "variables", "_initial_transient", "_aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10")
	...
	def __init__(self):
		...
		self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10 = process1____process2____process3____process4____process5____process6____process7____process8____process9____process10Automaton(self)
		self.components = [self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10]
	...
	def get_initial_state(self) -> State:
		...
		state.pc10 = 0
		state.coin10 = 0
		self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.set_initial_values(state)
		return state
	...
	def _get_initial_transient(self) -> Transient:
		...
		self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.set_initial_transient_values(transient)
		return transient
	...
	def _get_transient_value(self, state: State, transient_variable: str):
		...
		result = self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.get_transient_value(state, transient_variable)
	...
	def get_transitions(self, state: State) -> List[Transition]:
		...
		transitions = []
		trans_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10 = [[], [], [], []]
		transition_count = self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.get_transition_count(state)
		for i in range(transition_count):
			if self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.get_guard_value(state, i):
				trans_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10[self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.get_transition_label(state, i)].append(i)
		# Match automaton transitions onto synchronisation vectors
		for svi in range(len(self.sync_vectors)):
			sv = self.sync_vectors[svi]
			synced = [[-1, -1]]
			# process1 || process2 || process3 || process4 || process5 || process6 || process7 || process8 || process9 || process10
			if synced is not None:
				if sv[0] != -1:
					if len(trans_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10[sv[0]]) == 0:
						synced = None
					else:
						existing = len(synced)
						for i in range(existing):
							synced[i][0] = trans_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10[sv[0]][0]
						for i in range(1, len(trans_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10[sv[0]])):
							for j in range(existing):
								synced.append(synced[j][:])
								synced[-1][0] = trans_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10[sv[0]][i]
			if synced is not None:
				for sync in synced:
					sync[-1] = sv[-1]
					sync.append(svi)
	...
	def get_branches(self, state: State, transition: Transition) -> List[Branch]:
		...
		if transition.transitions[0] != -1:
			existing = len(combs)
			branch_count = self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.get_branch_count(state, transition.transitions[0])
			for i in range(1, branch_count):
				probability = self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.get_probability_value(state, transition.transitions[0], i)
				for j in range(existing):
					combs.append(combs[j][:])
					combs[-1][0] = i
					probs.append(probs[j] * probability)
			probability = self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.get_probability_value(state, transition.transitions[0], 0)
			for i in range(existing):
				combs[i][0] = 0
				probs[i] *= probability
	...
	def jump(self, state: State, transition: Transition, branch: Branch, expressions: List[int] = []) -> State:
		...
		for i in range(0, 1):
			...
			if transition.transitions[0] != -1:
				self._aut_process1____process2____process3____process4____process5____process6____process7____process8____process9____process10.jump(state, transient, transition.transitions[0], branch.branches[0], i, target_state, target_transient)
			state = target_state
