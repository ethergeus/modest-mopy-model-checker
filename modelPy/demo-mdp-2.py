...
class State(object):
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.state == other.state and self.Main_location == other.Main_location
...
class MainAutomaton(object):
	...
	def __init__(self, network: Network):
		...
		self.transition_counts = [5, 1]
		self.transition_labels = [[1, 2, 0, 1, 2], [0]]
		self.branch_counts = [[1, 1, 2, 1, 2], [1]]
...
class Network(object):
	...
	def __init__(self):
		...
		self.properties = [
			...
			Property("P3", PropertyExpression("e_max_s", [2, PropertyExpression("ap", [3])])),
			Property("P4", PropertyExpression("e_min_s", [2, PropertyExpression("ap", [0])]))
		]
		self.variables = [
