...
# States
class State(object):
	__slots__ = ("loc_2", "t_2", "boost_1", "user_1", "t_1", "loc_1", "failure_1", "battery_load")
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.loc_2 == other.loc_2 and self.t_2 == other.t_2 and self.boost_1 == other.boost_1 and self.user_1 == other.user_1 and self.t_1 == other.t_1 and self.loc_1 == other.loc_1 and self.failure_1 == other.failure_1 and self.battery_load == other.battery_load
...
class Process_2Automaton(object):
	...
	def __init__(self, network: Network):
		...
		self.branch_counts = [[1, 1, 1, 2, 1, 2]]
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			if transition == 0:
				return ((state.loc_2 == 2) and (state.t_2 != 0))
			elif transition == 1:
				return ((state.loc_2 == 2) and (state.t_2 == 0))
			elif transition == 2:
				return ((state.loc_2 == 0) and (state.user_1 != 2))
			elif transition == 3:
				return ((state.loc_2 == 0) and (state.user_1 == 2))
			elif transition == 4:
				return ((state.loc_2 == 1) and (state.t_2 > 0))
...
class ResourcesAutomaton(object):
	...
	def __init__(self, network: Network):
		...
		self.transition_labels = [[1, 1, 1, 1, 1, 1, 1, 1]]
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			if transition == 0:
				return ((state.user_1 == 0) and (state.loc_1 == 0))
			elif transition == 1:
				return (((state.user_1 == 0) and (state.loc_1 == 0)) or (((state.loc_1 == 0) and (state.t_2 == 0)) and ((state.user_1 == 2) and (state.loc_2 == 1))))
			elif transition == 2:
				return ((((state.user_1 == 1) and (not ((state.loc_1 == 1) and (state.t_1 == 0)))) or ((state.user_1 == 2) and (not ((state.loc_2 == 1) and (state.t_2 == 0))))) or (((state.user_1 == 0) and (state.loc_1 != 0)) and (state.loc_2 != 0)))
			elif transition == 3:
				return (((((state.loc_2 != 0) and (state.t_1 == 0)) and (state.user_1 == 1)) and ((state.loc_1 != 0) and (state.loc_1 == 1))) or ((((state.loc_2 != 0) and (state.t_2 == 0)) and (state.user_1 == 2)) and ((state.loc_1 != 0) and (state.loc_2 == 1))))
			elif transition == 4:
				return ((((state.loc_2 == 0) and (state.t_1 == 0)) and ((state.user_1 == 1) and (state.loc_1 == 1))) or ((state.user_1 == 0) and (state.loc_2 == 0)))
			elif transition == 5:
				return (((state.loc_2 == 0) and (state.t_1 == 0)) and ((state.user_1 == 1) and (state.loc_1 == 1)))
			elif transition == 6:
				return ((state.user_1 == 0) and (state.loc_2 == 0))
			elif transition == 7:
				return (((state.loc_1 == 0) and (state.t_2 == 0)) and ((state.user_1 == 2) and (state.loc_2 == 1)))
			else:
				raise IndexError
		else:
			raise IndexError
...
class Process_1Automaton(object):
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			if transition == 0:
				return ((state.loc_1 == 2) and (state.t_1 != 0))
			elif transition == 1:
				return ((state.loc_1 == 2) and (state.t_1 == 0))
			elif transition == 2:
				return ((state.loc_1 == 0) and (state.user_1 != 1))
			elif transition == 3:
				return ((state.loc_1 == 0) and (state.user_1 == 1))
			elif transition == 4:
				return ((state.loc_1 == 1) and (state.t_1 > 0))
