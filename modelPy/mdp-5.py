...
class Network(object):
	...
	def __init__(self):
		...
		self.properties = [
			...
			Property("P2", PropertyExpression("p_min", [PropertyExpression("eventually", [PropertyExpression("ap", [0])])])),
			Property("R1", PropertyExpression("e_max_s", [1, PropertyExpression("ap", [0])])),
			Property("R2", PropertyExpression("e_min_s", [1, PropertyExpression("ap", [0])]))
		]
		self.variables = [
