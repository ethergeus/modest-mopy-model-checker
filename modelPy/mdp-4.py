...
class Transient(object):
	__slots__ = ("countTransitions", "reward")
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.countTransitions == other.countTransitions and self.reward == other.reward
...
class ChooseAutomaton(object):
	...
	def __init__(self, network: Network):
		...
		self.transition_labels = [[1, 2], [0], [0], [1], [0]]
...
class Network(object):
	...
	def __init__(self):
		self.network = self
		self.model_type = "mdp"
		self.transition_labels = { 0: "τ", 1: "r", 2: "s" }
